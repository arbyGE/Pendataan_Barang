              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div style="overflow-x:auto;">
                    <div class="my-3 col-12 col-sm-8 col-md-6">
                      <form class="d-flex" role="search" action="" method="get">
                        <div class="input-group mb-3" >
                          <input class=" me-2 rounded-3" type="search" name="Search" placeholder="Search by nama" aria-label="Search" id="floatingInputGroup1" >
                    ...
                    <form  class="d-flex" role="search" action="" method="get">
                      <div class="input-group mb-3">
                        <select name="jenis" class=" me-3 rounded-3">
