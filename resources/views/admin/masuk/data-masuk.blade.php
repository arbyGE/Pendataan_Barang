                      ...
                      <div class="my-3 col-12 col-sm-8 col-md-6">
                        <form action="" method="get">
                          <div class="input-group mb-3">
                            <input class="rounded-3 me-3" type="search" name="Search" placeholder="Search by bulan" aria-label="Search" id="floatingInputGroup1">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/admin/masuk/data-masuk" method="post">
          @csrf
          <div class="mb-3">
